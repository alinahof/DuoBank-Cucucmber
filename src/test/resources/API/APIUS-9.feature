...
#    API US 9. Test Case 1: Get User details valid JWT\
    Scenario: Retrieve a single user with valid JWT token
      ...
      And the request "Authorization" header is set to "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwOlwvXC9sb2NhbGhvc3RcL2xvYW5cL2FwaSIsImF1ZCI6Imh0dHA6XC9cL2xvY2FsaG9zdFwvbG9hblwvYXBpIiwiaWF0IjoxNjkzMjUyNTU5LCJleHAiOjE2OTMyNTYxNTksImRhdGEiOnsidXNlcl9pZCI6IjExOTgiLCJ0eXBlIjoiMiJ9fQ.uHcxQvTFtUDLxdCtjCdMpVkay7Knoip9ZmuSFUu0MIE"
